  ...
  <div id="settingIndex">
    <Tyh-card shadow="always" simple>
      ...
      <Tyh-button
        ...
        :simple="changeUserInfoBtnSimple"
    ...
    <Tyh-card shadow="always" simple>
      ...
      <el-form :model="changePass" ref="changePass" label-width="80px">
        <!-- 原始密码 -->
...
export default {
  ...
  data () {
    return {
      ...
      changeUserInfoBtnSimple: false, // 更新用户信息的按钮禁用状态
  ...
  methods: {
    ...
    // 保存用户资料
    SaveData () {
      this.changeUserInfoBtnSimple = true
      this.$refs.userForm.validate(async (valid) => {
        if (!valid) {
          this.changeUserInfoBtnSimple = false
          return
        }
        const newObj = {}
